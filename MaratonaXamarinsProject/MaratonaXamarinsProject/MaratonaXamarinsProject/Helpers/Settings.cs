...
namespace MaratonaXamarinsProject.Helpers
{
    /// <summary>
    ...
    public static class Settings
    {
        ...
        const string FacebookTokenKey = "fbtoken";
        static readonly string FacebookTokenDefault = string.Empty;

        public static string FacebookToken
        {
            get { return AppSettings.GetValueOrDefault<string>(FacebookTokenKey, FacebookTokenDefault); }
            set { AppSettings.AddOrUpdateValue<string>(FacebookTokenKey, value); }
        }
